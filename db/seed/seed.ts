    ...
    const users = [
      {
        ...
        handle: 'alicejohnson',
        description: '☕ Coffee enthusiast and digital nomad. Love discovering cozy cafés and sharing great spots with fellow travelers.',
        emailVerified: true,
      ...
      },
      {
        ...
        handle: 'bobsmith',
        description: '🍕 Foodie on a mission to find the best restaurants in the city. Always up for trying new cuisines!',
        emailVerified: true,
      ...
      },
      {
        ...
        handle: 'charliebrown',
        description: '🥾 Adventure seeker and nature lover. When I\'m not hiking, you can find me planning my next outdoor expedition.',
        emailVerified: true,
      ...
      },
      {
        ...
        handle: 'dianaprince',
        description: '🎨 Art curator and culture enthusiast. I believe art has the power to transform communities and inspire change.',
        emailVerified: true,
      ...
      },
      {
        ...
        handle: 'evewilson',
        description: '🏖️ Beach lover and wellness advocate. Life\'s too short not to enjoy the simple pleasures by the ocean.',
        emailVerified: true,
      ...
      },
      {
        ...
        handle: 'frankmiller',
        description: '💻 Tech entrepreneur and startup mentor. Passionate about innovation and building communities for creators.',
        emailVerified: true,
    ...
    const locations = [
      {
        ...
        description: 'A charming neighborhood café serving artisanal coffee and fresh pastries. Perfect for remote work with reliable WiFi and cozy seating areas.',
      ...
      },
      {
        ...
        description: 'Elegant dining with stunning river views. Features seasonal Italian cuisine, an extensive wine list, and outdoor terrace seating.',
      ...
      },
      {
        ...
        description: 'Scenic 3-mile hiking trail offering breathtaking panoramic views of the city skyline. Moderate difficulty with well-marked paths.',
      ...
      },
      {
        ...
        description: 'Contemporary art gallery featuring rotating exhibitions from emerging and established artists. Free admission on Sundays.',
      ...
      },
      {
        id: randomUUID(),
        name: 'Seaside Beach',
        description: 'Beautiful sandy beach with crystal clear waters. Family-friendly with lifeguards on duty, beach volleyball courts, and snack bars.',
      ...
      },
      {
        ...
        description: 'Modern co-working space designed for entrepreneurs and creatives. Features high-speed internet, meeting rooms, and networking events.',
