...
import { getUserReviewsPaginated, getLocationReviewsPaginated } from '@/modules/review/server';
...
export async function loadLocationReviews(locationId: string, page: number = 1, pageSize: number = 3 * 3) {
